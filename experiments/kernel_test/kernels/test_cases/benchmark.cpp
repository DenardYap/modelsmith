...
// Optional reference wrappers still declared
torch::Tensor binary_matmul(torch::Tensor A_bin, torch::Tensor B_bin);
torch::Tensor binary_matmul64(torch::Tensor A_bin, torch::Tensor B_bin);
torch::Tensor binary_matmul128(torch::Tensor A_bin, torch::Tensor B_bin);
torch::Tensor binary_matmul128_tiled(torch::Tensor A_bin, torch::Tensor B_bin);
torch::Tensor binary_matmul128_tiled_unrolled(torch::Tensor A_bin, torch::Tensor B_bin);
torch::Tensor binary_matmul128_tiled_old(torch::Tensor A_bin, torch::Tensor B_bin);
torch::Tensor binary_matmul128_int(torch::Tensor A_bin, torch::Tensor B_bin);
torch::Tensor binary_matmul_float_bitpack(torch::Tensor A_bin, torch::Tensor B_bin);
torch::Tensor binary_matmul_optimized(torch::Tensor A_bin, torch::Tensor B_bin);
